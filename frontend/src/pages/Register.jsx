            ...
            <main className="relative z-20 w-full max-w-md px-6">
                <div className="bg-black/80 backdrop-blur-md border border-primary/40 p-8 md:p-12 rounded-none neon-border">
                    ...
                    <div className="mt-8 space-y-3">
                        <a
                            href={`${Object.assign({ "VITE_API_URL": "http://localhost:5000" }, import.meta.env).VITE_API_URL}/api/auth/google`}
                        ...
                        <a
                            href={`${Object.assign({ "VITE_API_URL": "http://localhost:5000" }, import.meta.env).VITE_API_URL}/api/auth/spotify`}
